...
/**
 * Get deep wiki content as a separate message for the conversation
 */
export async function getDeepWikiMessage(
  taskId: string
): Promise<string | null> {
...
// Backward compatibility - default system prompt without deep wiki (uses static guidance)
