  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out ease-out-quad fixed z-50 flex flex-col gap-4 shadow-lg transition data-[state=closed]:duration-300 data-[state=open]:duration-300",
          side === "right" &&
